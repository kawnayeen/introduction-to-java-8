 ...
 */
package com.kawnayeen.java8._2_stream._4_Exercise._02;
...
public class RandomWords {
    ...
    public RandomWords() throws IOException {
        try (BufferedReader reader = Files.newBufferedReader(Paths.get("storage/stream_ex02/words.txt"))) {
            //sourceWords = null;    // YOUR CODE HERE
            sourceWords = reader.lines().parallel().collect(Collectors.toList());
    ...
    public List<String> createList(int listSize) {
        ...
        wordList = sourceWords.parallelStream().limit(listSize).collect(Collectors.toList());
        return wordList;
    }
