...
public class Exercise02 {
     ...
     */
    static Integer[][] computeLevenshtein(List<String> wordList, boolean parallel) {
        ...
        Integer[][] distances = intStream
                .mapToObj(r -> IntStream.range(0, LIST_SIZE)
                        .mapToObj(c -> (Levenshtein.lev(wordList.get(r), wordList.get(c))))
                        .toArray(Integer[]::new))
                .toArray(Integer[][]::new);
        return distances;
    ...
    static List<String> processWords(List<String> wordList, boolean parallel) {
        ...
        return
                stringStream.sorted().map(String::toLowerCase).collect(Collectors.toList());
    }
